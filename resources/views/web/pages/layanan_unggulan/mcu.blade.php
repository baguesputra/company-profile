...
<section class="layanan-unggulan-hero">
   <div class="container">
        <h2 class="judul-layanan-unggulan">Medical Check Up (MCU)</h2>
        <p class="deskripsi-layanan-unggulan">
            Pemeriksaan kesehatan menyeluruh untuk deteksi dini penyakit.
        </p>
    </div>
</section>

<section id="mcu" class="container my-5">
    <div class="row">
        <div class="col-12">
            <h2 class="text-center mb-4 text-success fw-bold">Medical Check Up (MCU)</h2>
            <p class="text-center mb-5">
                Medical Check Up di Rumah Sakit Amanah Medical Centre menyediakan pemeriksaan kesehatan menyeluruh untuk deteksi dini penyakit. Dengan paket MCU yang komprehensif, termasuk tes darah, EKG, dan pemeriksaan fisik, kami membantu Anda menjaga kesehatan optimal.
            </p>
        </div>
    </div>
    ...
    <div class="row g-4 justify-content-center">
        @php
            $dokterMCU = [
                ['name' => 'Dr. Rudi Hartono', 'image' => 'doktor6.jpg'],
            ];
        @endphp

        @foreach ($dokterMCU as $dokter)
            <div class="col-md-4">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text text-muted">Spesialis Penyakit Dalam</p>
                    </div>
                </div>
            </div>
        @endforeach
