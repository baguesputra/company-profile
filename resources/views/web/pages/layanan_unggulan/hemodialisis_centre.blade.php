...
<section class="layanan-unggulan-hero">
   <div class="container">
        <h2 class="judul-layanan-unggulan">Hemodialisis Centre</h2>
        <p class="deskripsi-layanan-unggulan">
            Pusat hemodialisis untuk pasien gagal ginjal dengan peralatan modern.
        </p>
    </div>
</section>

<section id="hemodialisis-centre" class="container my-5">
    <div class="row">
        <div class="col-12">
            <h2 class="text-center mb-4 text-success fw-bold">Hemodialisis Centre</h2>
            <p class="text-center mb-5">
                Hemodialisis Centre di Rumah Sakit Amanah Medical Centre menyediakan layanan hemodialisis berkualitas tinggi untuk pasien gagal ginjal. Dengan peralatan modern dan tim medis berpengalaman, kami berkomitmen untuk memberikan perawatan yang nyaman dan efektif.
            </p>
        </div>
    </div>
    ...
    <div class="row g-4 justify-content-center">
        @php
            $dokterHemodialisis = [
                ['name' => 'Dr. Sari Indah', 'image' => 'doktor10.jpg'],
            ];
        @endphp

        @foreach ($dokterHemodialisis as $dokter)
            <div class="col-md-4">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text text-muted">Spesialis Nefrologi</p>
                    </div>
                </div>
            </div>
        @endforeach
