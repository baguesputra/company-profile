...
<section class="layanan-unggulan-hero">
   <div class="container">
        <h2 class="judul-layanan-unggulan">Maternity Centre</h2>
        <p class="deskripsi-layanan-unggulan">
            Layanan kebidanan dan persalinan dengan fasilitas lengkap.
        </p>
    </div>
</section>

<section id="maternity-centre" class="container my-5">
    <div class="row">
        <div class="col-12">
            <h2 class="text-center mb-4 text-success fw-bold">Maternity Centre</h2>
            <p class="text-center mb-5">
                Maternity Centre di Rumah Sakit Amanah Medical Centre menyediakan layanan kebidanan dan persalinan yang lengkap dan aman. Dari perawatan kehamilan hingga persalinan, tim spesialis kami siap mendampingi Anda dengan fasilitas modern dan pendekatan yang penuh perhatian.
            </p>
        </div>
    </div>
    ...
    <div class="row g-4 justify-content-center">
        @php
            $dokterMaternity = [
                ['name' => 'Dr. Maya Sari', 'image' => 'doktor12.jpg'],
            ];
        @endphp

        @foreach ($dokterMaternity as $dokter)
            <div class="col-md-4">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text text-muted">Spesialis Kebidanan</p>
                    </div>
                </div>
            </div>
        @endforeach
