...
<section class="layanan-unggulan-hero">
   <div class="container">
        <h2 class="judul-layanan-unggulan">Cathlab</h2>
        <p class="deskripsi-layanan-unggulan">
            Layanan kateterisasi jantung untuk diagnosis dan pengobatan penyakit jantung.
        </p>
    </div>
</section>

<section id="cathlab" class="container my-5">
    <div class="row">
        <div class="col-12">
            <h2 class="text-center mb-4 text-success fw-bold">Cathlab</h2>
            <p class="text-center mb-5">
                Cathlab di Rumah Sakit Amanah Medical Centre menyediakan layanan kateterisasi jantung yang canggih untuk diagnosis dan pengobatan penyakit jantung. Dengan teknologi terkini, kami memastikan prosedur yang aman dan efektif untuk kesehatan jantung Anda.
            </p>
        </div>
    </div>
    ...
    <div class="row g-4 justify-content-center">
        @php
            $dokterCathlab = [
                ['name' => 'Dr. Ahmad Fauzi', 'image' => 'doktor9.jpg'],
            ];
        @endphp

        @foreach ($dokterCathlab as $dokter)
            <div class="col-md-4">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text text-muted">Spesialis Kardiovaskular</p>
                    </div>
                </div>
            </div>
        @endforeach
