...
<section class="layanan-unggulan-hero">
   <div class="container">
        <h2 class="judul-layanan-unggulan">Fertilisasi In Vitro (IVF)</h2>
        <p class="deskripsi-layanan-unggulan">
            Layanan reproduksi berbantu bagi pasangan yang ingin memiliki anak.
        </p>
    </div>
</section>

<section id="ivf" class="container my-5">
    <div class="row">
        <div class="col-12">
            <h2 class="text-center mb-4 text-success fw-bold">Fertilisasi In Vitro (IVF)</h2>
            <p class="text-center mb-5">
                Layanan Fertilisasi In Vitro (IVF) di Rumah Sakit Amanah Medical Centre membantu pasangan yang mengalami kesulitan memiliki anak. Dengan teknologi reproduksi berbantu terkini dan tim spesialis fertilitas, kami menyediakan solusi yang aman dan efektif untuk mewujudkan impian keluarga.
            </p>
        </div>
    </div>
    ...
    <div class="row g-4 justify-content-center">
        @php
            $dokterIVF = [
                ['name' => 'Dr. Sari Dewi', 'image' => 'doktor7.jpg'],
            ];
        @endphp

        @foreach ($dokterIVF as $dokter)
            <div class="col-md-4">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text text-muted">Spesialis Fertilitas</p>
                    </div>
                </div>
            </div>
        @endforeach
