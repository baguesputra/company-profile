...
<section class="layanan-unggulan-hero">
   <div class="container">
        <h2 class="judul-layanan-unggulan">One Day Care</h2>
        <p class="deskripsi-layanan-unggulan">
            Perawatan medis singkat, pasien bisa pulang di hari yang sama.
        </p>
    </div>
</section>

<section id="one-day-care" class="container my-5">
    <div class="row">
        <div class="col-12">
            <h2 class="text-center mb-4 text-success fw-bold">One Day Care</h2>
            <p class="text-center mb-5">
                One Day Care di Rumah Sakit Amanah Medical Centre menyediakan perawatan medis singkat yang memungkinkan pasien untuk pulang di hari yang sama. Layanan ini ideal untuk prosedur minor seperti endoskopi, kolonoskopi, dan perawatan lainnya yang tidak memerlukan rawat inap.
            </p>
        </div>
    </div>
    ...
    <div class="row g-4 justify-content-center">
        @php
            $dokterODC = [
                ['name' => 'Dr. Ahmad Rahman', 'image' => 'doktor2.jpg'],
            ];
        @endphp

        @foreach ($dokterODC as $dokter)
            <div class="col-md-4">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text text-muted">Spesialis Bedah Umum</p>
                    </div>
                </div>
            </div>
        @endforeach
