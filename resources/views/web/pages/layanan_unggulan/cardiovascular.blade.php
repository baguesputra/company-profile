...
<section class="layanan-unggulan-hero">
   <div class="container">
        <h2 class="judul-layanan-unggulan">Cardiovascular</h2>
        <p class="deskripsi-layanan-unggulan">
            Pelayanan jantung & pembuluh darah dengan tenaga medis ahli.
        </p>
    </div>
</section>

<section id="cardiovascular" class="container my-5">
    <div class="row">
        <div class="col-12">
            <h2 class="text-center mb-4 text-success fw-bold">Cardiovascular</h2>
            <p class="text-center mb-5">
                Layanan Cardiovascular di Rumah Sakit Amanah Medical Centre fokus pada diagnosis dan pengobatan penyakit jantung dan pembuluh darah. Dengan tim spesialis jantung berpengalaman dan peralatan canggih seperti angiografi dan echocardiography, kami berkomitmen untuk memberikan perawatan terbaik.
            </p>
        </div>
    </div>
    ...
    <div class="row g-4 justify-content-center">
        @php
            $dokterCardio = [
                ['name' => 'Dr. Lina Sari', 'image' => 'doktor4.jpg'],
            ];
        @endphp

        @foreach ($dokterCardio as $dokter)
            <div class="col-md-4">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text text-muted">Spesialis Jantung</p>
                    </div>
                </div>
            </div>
        @endforeach
